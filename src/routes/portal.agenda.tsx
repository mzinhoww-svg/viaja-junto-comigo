...
export const Route = createFileRoute("/portal/agenda")({
  ssr: false,
  head: () => ({ meta: [{ title: "Agendamentos — Viajaly" }] }),
  ...
  return (
    <PhoneFrame>
      <div className="px-5 pt-8 pb-24 anim-vfade">
        ...
        <h1 className="mt-6 text-2xl font-display font-extrabold text-navy">Agendamentos</h1>
        <p className="mt-1 text-ink-soft text-sm">
          Escolha as datas que funcionam para cada viajante. A Viajaly confirma a melhor disponível.
        </p>
