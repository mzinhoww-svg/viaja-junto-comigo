...
| Ticket em aberto aguardando review | **VJT-015 Instrumentação PostHog** — issue [#66](https://github.com/mzinhoww-svg/viaja-junto-comigo/issues/66), PR [#67](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/67) (draft, `claude/posthog-vjt-015-mj9gmj`). Sem migration. Detalhes na entrada do Log abaixo |
...
### 2026-07-25 — VJT-015 Instrumentação PostHog — **PR aberto (draft), aguardando review** (issue [#66](https://github.com/mzinhoww-svg/viaja-junto-comigo/issues/66), PR [#67](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/67), branch `claude/posthog-vjt-015-mj9gmj`)
