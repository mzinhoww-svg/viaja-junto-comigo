  ...
  public: {
    ...
    Views: {
      requests_safe: {
        Row: {
          ...
          proposal_sent_at: string | null;
          proposal_status: Database["public"]["Enums"]["proposal_status_t"] | null;
    ...
    Functions: {
      ab_results: {
        ...
        Returns: { variant: string; views: number; converts: number }[];
      };
    ...
    Enums: {
      ...
      checklist_type: "documentos" | "preparativos" | "mala" | "compras" | "custom";
