...
| Campo | Valor |
|---|---|
| Onda atual | 1 (Fundação) + 2 (Financeiro/Checklists, em andamento) — VJT-001, VJT-002, VJT-003, VJT-003b, VJT-003c, VJT-004 e VJT-008 mergeados. VJT-004b **em execução** (ver linha abaixo). VJT-005/VJT-006 seguem executáveis em paralelo (bloqueados só por VJT-004, já mergeado); VJT-007 aguarda VJT-004b mergear |
| Último ticket concluído (mergeado) | VJT-004 (PR [#25](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/25), issue #22, mergeado em 2026-07-24) — mergeado na mesma sessão que VJT-003b (PR [#24](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/24), issue #21) e VJT-003c (PR [#23](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/23), issue #20). Detalhes no Log (Seção 8) |
| Ticket em aberto aguardando review | **VJT-004b** — Extrair `MARCOS_CONHECIDOS` para módulo compartilhado (PR [#27](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/27), issue [#26](https://github.com/mzinhoww-svg/viaja-junto-comigo/issues/26), aberto 2026-07-24, branch `claude/vjt-004b-marcos-shared`). CI em andamento no momento da abertura; sessão inscrita nos eventos do PR, acompanha CI/review até merge ou fechamento |
...
| Última atualização desta seção | 2026-07-24 (esta sessão: abertura de VJT-004b, issue #26/PR #27) |
