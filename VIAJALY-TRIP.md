...
| Campo | Valor |
|---|---|
| Onda atual | 1 (Fundação) + 2 (Financeiro/Checklists) + 3 (Roteiro+PDF) + 4 (Visto) + 5 (Monetização, parcial) fechadas — VJT-001, VJT-002, VJT-003, VJT-003b, VJT-003c, VJT-004, VJT-004b, VJT-005, VJT-006, VJT-007, VJT-007b, VJT-008, VJT-009, VJT-010 e **VJT-011** mergeados (VJT-011 mergeado em 2026-07-25T15:39:36Z, PR #51, confirmado via API do GitHub). **VJT-012** (este ticket) e **VJT-016** (sessão paralela) têm PR aberto aguardando review humano (ver linha abaixo). **Executável agora** (sem issue/PR ainda, a reconfirmar antes de despachar): VJT-013, VJT-014, VJT-015, VJT-017 — todos bloqueados só por VJT-011, que já mergeou. VJT-011b (Seção 7, sem bloqueio) também já pode ser pego a qualquer momento |
| Último ticket concluído (mergeado) | VJT-011 (PR [#51](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/51), issue #50, mergeado em 2026-07-25T15:39:36Z, confirmado via API do GitHub — `merged: true`, `merged_by: mzinhoww-svg`, commit de merge `d0f542d`). Detalhes no Log (Seção 8) |
| Ticket em aberto aguardando review | **VJT-012** Checkout Stripe + webhook (issue [#54](https://github.com/mzinhoww-svg/viaja-junto-comigo/issues/54), PR [#55](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/55), branch `claude/stripe-checkout-webhook-vjt-012-5ne0m6`) — ver Log (Seção 8). **VJT-016** PWA (issue [#52](https://github.com/mzinhoww-svg/viaja-junto-comigo/issues/52), PR [#53](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/53)) — sessão paralela, não tocada por esta |
...
| Última atualização desta seção | 2026-07-25 (VJT-012 implementado nesta sessão — issue #54 e PR #55 abertos; VJT-016 também tem PR aberto #53 via sessão paralela; VJT-013/014/015/017 seguem executáveis sem issue/PR ainda; VJT-011b segue aberto, sem bloqueio) |
