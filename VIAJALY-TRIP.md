...
| Campo | Valor |
|---|---|
| Onda atual | 1 (Fundação) + 2 (Financeiro/Checklists) + 3 (Roteiro+PDF) + 4 (Visto) fechadas — VJT-001, VJT-002, VJT-003, VJT-003b, VJT-003c, VJT-004, VJT-004b, VJT-005, VJT-006, VJT-007, VJT-007b, VJT-008, VJT-009 e VJT-010 mergeados. **Onda 5 (Monetização) iniciada**: **VJT-011** implementado nesta sessão, PR aberto aguardando review humano (não mergeado); revisão humana já rodou uma passada no diff real e pediu 2 correções (migration idempotente + backstop de realtime), aplicadas nesta sessão. VJT-011b (achado da mesma revisão: runbook de ativação manual + contagem do teaser premium por variáveis reais da trip) aberto na Seção 7, sem bloqueio. Próximo executável só depois do merge de VJT-011: VJT-012/VJT-013/VJT-014/VJT-015/VJT-016/VJT-017 estão todos bloqueados por ele |
...
| Última atualização desta seção | 2026-07-25 (VJT-011: revisão humana no diff real do PR #51 pediu migration idempotente + backstop de realtime + correção da contagem de testes na descrição; aplicado nesta sessão, VJT-011b aberto para as 2 pendências restantes; PR segue aguardando aprovação final) |
...
### 2026-07-25 — VJT-011 Entitlements + paywall único — **Aguardando review** (PR [#51](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/51), issue [#50](https://github.com/mzinhoww-svg/viaja-junto-comigo/issues/50))
