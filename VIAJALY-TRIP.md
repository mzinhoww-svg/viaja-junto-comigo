...
| Campo | Valor |
|---|---|
| Onda atual | 1 (Fundação) + 2 (Financeiro/Checklists) + 3 (Roteiro+PDF) + 4 (Visto) + 5 (Monetização, parcial) + 7 (Polimento, parcial) fechadas — VJT-001, VJT-002, VJT-003, VJT-003b, VJT-003c, VJT-004, VJT-004b, VJT-005, VJT-006, VJT-007, VJT-007b, VJT-008, VJT-009, VJT-010, VJT-011 e **VJT-016** mergeados (VJT-016 mergeado em 2026-07-25T16:40:54Z, PR #53, confirmado via API do GitHub). **Ainda executável**: VJT-012, VJT-013, VJT-014, VJT-015 e VJT-017 — todos bloqueados só por VJT-011, que já mergeou; nenhum tem issue/PR aberto ainda (a confirmar de novo na próxima sessão antes de despachar, conforme protocolo). VJT-011b (Seção 7, sem bloqueio) também já pode ser pego a qualquer momento |
| Último ticket concluído (mergeado) | VJT-016 (PR [#53](https://github.com/mzinhoww-svg/viaja-junto-comigo/pull/53), issue [#52](https://github.com/mzinhoww-svg/viaja-junto-comigo/issues/52), mergeado em 2026-07-25T16:40:54Z, confirmado via API do GitHub — `merged: true`, `merged_by: mzinhoww-svg`, commit de merge `670b918`). Detalhes no Log (Seção 8) |
...
| Última atualização desta seção | 2026-07-25 (VJT-016 mergeado — PR #53 confirmado via API do GitHub; VJT-012 a VJT-015 e VJT-017 seguem executáveis, sem issue/PR aberto ainda; VJT-011b segue aberto, sem bloqueio) |
