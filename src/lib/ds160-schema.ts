...
export const DS160_SECTIONS: Section[] = [
    ...
    fields: [
      {
        ...
        required: true,
        mask: "mrz",
        ds160Section: "Personal Information 1",
        help: "MAIÚSCULAS, sem acento (MRZ)",
      },
      {
        key: "given_name",
      ...
      },
      {
        ...
        ds160Section: "Personal Information 2",
      },
      {
        key: "birth_city",
      ...
      {
        key: "qual_nac",
        label: "Qual outra nacionalidade?",
        type: "text",
        ds160Section: "Personal Information 2",
        when: { field: "outra_nac", equals: "Sim" },
      },
      {
        key: "passaporte_outra_nac",
        label: "Tem passaporte dessa outra nacionalidade?",
        type: "yesno",
        ds160Section: "Personal Information 2",
        when: { field: "outra_nac", equals: "Sim" },
      },
      {
        key: "had_other_names",
        label: "Já usou outros nomes (apelido, nome social, solteiro)?",
        type: "yesno",
        required: true,
        ds160Section: "Personal Information 2",
      },
      {
        key: "other_names",
        label: "Quais outros nomes?",
        type: "text",
        mask: "mrz",
        ds160Section: "Personal Information 2",
        when: { field: "had_other_names", equals: "Sim" },
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        ds160Section: "Address and Phone",
      },
      {
        key: "phone_primary",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Cidade / estado de emissão",
        type: "text",
        required: true,
        ds160Section: "Passport",
      },
      ...
      },
      {
        ...
        required: true,
        ds160Section: "Passport",
        help: "Deve ter validade mínima de 6 meses",
      },
      {
        key: "other_passport",
        label: "Possui outro passaporte?",
        type: "yesno",
        required: true,
        ds160Section: "Passport",
      },
      {
        key: "passport_lost",
        label: "Já teve passaporte perdido ou roubado?",
        type: "yesno",
        required: true,
        ds160Section: "Passport",
      },
      {
        key: "passport_lost_details",
        label: "Detalhes da perda/roubo",
        type: "textarea",
        ds160Section: "Passport",
        when: { field: "passport_lost", equals: "Sim" },
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        key: "trip_destination_city",
        label: "Cidade de destino principal",
        type: "text",
        required: true,
        ds160Section: "Travel",
      },
      {
        key: "trip_us_address",
        label: "Endereço de hospedagem / hotel nos EUA",
        type: "textarea",
        required: true,
        ds160Section: "Travel",
      },
      {
        key: "trip_arrival_date",
      ...
      },
      {
        ...
        label: "Tempo estimado de permanência",
        type: "text",
        required: true,
      ...
      },
      {
        ...
        type: "select",
        required: true,
        options: ["Eu mesmo(a)", "Familiar", "Empresa", "Outro"],
        ds160Section: "Travel",
      },
      {
        key: "trip_payer_name",
        label: "Nome de quem paga",
        type: "text",
        ds160Section: "Travel",
        when: { field: "trip_paid_by", in: ["Familiar", "Empresa", "Outro"] },
      },
      {
        key: "trip_payer_relation",
        label: "Relação com quem paga",
        type: "text",
        ds160Section: "Travel",
        when: { field: "trip_paid_by", in: ["Familiar", "Empresa", "Outro"] },
      },
      {
        key: "trip_with_companions",
        label: "Viajará acompanhado?",
        type: "yesno",
        required: true,
        ds160Section: "Travel Companions",
      },
      {
        key: "trip_companions",
        label: "Companheiros (nome + parentesco)",
        type: "textarea",
        ds160Section: "Travel Companions",
        when: { field: "trip_with_companions", equals: "Sim" },
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: "yesno",
        required: true,
        ds160Section: "Previous U.S. Travel",
      },
      {
        key: "us_last_visit",
        label: "Datas e duração das últimas viagens",
        type: "textarea",
        ds160Section: "Previous U.S. Travel",
        when: { field: "us_been_before", equals: "Sim" },
      },
      {
        key: "us_visa_before",
        label: "Já teve visto americano?",
        type: "yesno",
        required: true,
        ds160Section: "Previous U.S. Travel",
      },
      {
        key: "prev_visa_type",
        label: "Tipo do último visto",
        type: "text",
        placeholder: "Ex.: B1/B2",
        ds160Section: "Previous U.S. Travel",
        when: { field: "us_visa_before", equals: "Sim" },
      },
      {
        key: "prev_visa_issue_date",
        label: "Data de emissão do visto",
        type: "date",
        ds160Section: "Previous U.S. Travel",
        when: { field: "us_visa_before", equals: "Sim" },
      },
      {
        key: "prev_visa_expiry_date",
        label: "Data de expiração do visto",
        type: "date",
        ds160Section: "Previous U.S. Travel",
        when: { field: "us_visa_before", equals: "Sim" },
      },
      ...
      {
        key: "us_visa_refused",
        label: "Já teve visto negado ou cancelado?",
        type: "yesno",
        required: true,
        ds160Section: "Previous U.S. Travel",
      },
      {
        key: "us_visa_refused_details",
        label: "Detalhes da recusa/cancelamento",
        type: "textarea",
        ds160Section: "Previous U.S. Travel",
        when: { field: "us_visa_refused", equals: "Sim" },
      },
      {
        key: "us_entry_denied",
        label: "Já teve entrada negada nos EUA?",
        type: "yesno",
        required: true,
        ds160Section: "Previous U.S. Travel",
      },
      {
        key: "us_petition",
        label: "Há petição de imigração em seu nome?",
        type: "yesno",
        required: true,
        ds160Section: "Previous U.S. Travel",
      },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        subsection: "Cônjuge",
        ds160Section: "Family Spouse",
        when: { field: "marital_status", in: ["Casado(a)", "União estável"] },
      },
      {
      ...
      {
        key: "ex_spouse_name",
        label: "Nome do ex-cônjuge",
        type: "text",
        subsection: "Ex-cônjuge",
        ds160Section: "Family Spouse",
        when: { field: "marital_status", equals: "Divorciado(a)" },
      },
      {
        key: "ex_marriage_date",
      ...
      {
        key: "relatives_in_us_yesno",
        label: "Tem parentes nos EUA?",
        type: "yesno",
        required: true,
        subsection: "Parentes e contato nos EUA",
        ds160Section: "Family Relatives",
      },
      {
        key: "relatives_in_us",
        label: "Detalhe (nome + parentesco + status)",
        type: "textarea",
        subsection: "Parentes e contato nos EUA",
        ds160Section: "Family Relatives",
        when: { field: "relatives_in_us_yesno", equals: "Sim" },
      },
      {
        key: "us_contact",
        label: "Pessoa ou hotel de referência nos EUA",
        type: "text",
        required: true,
        subsection: "Parentes e contato nos EUA",
        placeholder: "Nome ou hotel",
        ds160Section: "Family Relatives",
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "employer_name",
        label: 'Empresa atual (ou "Autônomo")',
        type: "text",
        required: true,
        ds160Section: "Present Work/Education",
      },
      {
        key: "occupation",
        label: "Cargo",
      ...
      {
        key: "prev_employer",
        label: "Teve emprego nos últimos 5 anos?",
        type: "yesno",
        required: true,
        ds160Section: "Previous Work/Education",
      },
      {
        key: "prev_employer_details",
        label: "Empresa anterior, cargo e período",
        type: "textarea",
        ds160Section: "Previous Work/Education",
        when: { field: "prev_employer", equals: "Sim" },
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        label: "Instituição de ensino (mais recente)",
        type: "text",
        required: true,
        ds160Section: "Previous Work/Education",
      },
      ...
      {
        key: "education_city",
        label: "Cidade / estado da instituição",
        type: "text",
        ds160Section: "Previous Work/Education",
      },
      {
      ...
      {
        key: "education_end",
        label: 'Conclusão (MM/AAAA ou "cursando")',
        type: "text",
        ds160Section: "Previous Work/Education",
      },
      {
        key: "postgrad",
        label: "Tem pós, MBA ou especialização?",
        type: "yesno",
        required: true,
        ds160Section: "Previous Work/Education",
      },
      {
        key: "postgrad_details",
        label: "Detalhes da pós/MBA/especialização",
        type: "textarea",
        ds160Section: "Previous Work/Education",
        when: { field: "postgrad", equals: "Sim" },
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        ds160Section: "Additional Work/Education/Training",
      },
      {
        key: "other_countries",
        label: "Países visitados nos últimos 5 anos",
        type: "textarea",
        ds160Section: "Additional Work/Education/Training",
      },
      {
      ...
      },
      {
        ...
        label: "Detalhes do serviço militar",
        type: "textarea",
        ds160Section: "Additional Work/Education/Training",
        when: { field: "military_served", equals: "Sim" },
      },
      {
        key: "sec_disease",
        label: "Possui doença contagiosa relevante para saúde pública?",
        type: "yesno",
        required: true,
        flag: "review",
        subsection: "Perguntas de elegibilidade (governo dos EUA)",
        ds160Section: "Security and Background",
      },
      {
        key: "sec_crime",
        label: "Já foi preso(a) ou condenado(a) por qualquer crime?",
        type: "yesno",
        required: true,
        flag: "review",
        subsection: "Perguntas de elegibilidade (governo dos EUA)",
      ...
      {
        key: "sec_drugs",
        label: "Envolvimento com substâncias ilícitas?",
        type: "yesno",
        required: true,
        flag: "review",
        subsection: "Perguntas de elegibilidade (governo dos EUA)",
      ...
      {
        key: "sec_immigration_fraud",
        label: "Já cometeu fraude migratória?",
        type: "yesno",
        required: true,
        flag: "review",
        subsection: "Perguntas de elegibilidade (governo dos EUA)",
      ...
      {
        key: "sec_overstay",
        label: "Já permaneceu além do permitido nos EUA?",
        type: "yesno",
        required: true,
        flag: "review",
        subsection: "Perguntas de elegibilidade (governo dos EUA)",
      ...
      {
        key: "sec_notes",
        label: 'Detalhamento (obrigatório se respondeu "Sim" acima)',
        type: "textarea",
        subsection: "Perguntas de elegibilidade (governo dos EUA)",
        ds160Section: "Security and Background",
      },
