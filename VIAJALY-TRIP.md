...
| Última atualização desta seção | 2026-07-25 (VJT-015 executado e enviado para review — PR #68 draft. Antes de começar, confirmado via API do GitHub que os únicos PRs abertos eram #63 (troca de provider de IA, sem instrumentação) e #64 (fixture de teste de RLS, follow-up do VJT-013) — nenhum ticket de feature em paralelo, então este ticket, que toca eventos em quase todo o app, rodou sozinho como pedido. Durante a execução, o VJT-017b abriu o PR #67 e criou um conflito de premissa com a âncora do evento `signup` — resolvido dentro do próprio VJT-015, ver a entrada do Log) |
