...
```bash
python <docx-skill>/scripts/office/validate.py reports/seo-audit-[domain]-[date].docx
```
...
```bash
python <docx-skill>/scripts/office/soffice.py --headless --convert-to pdf reports/seo-audit-[domain]-[date].docx --outdir reports/
```
...
[Download Word Doc](computer://reports/seo-audit-[domain]-[date].docx)
[Download PDF](computer://reports/seo-audit-[domain]-[date].pdf)
```
