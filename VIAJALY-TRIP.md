...
| Última atualização desta seção | 2026-07-25 (consolidação de onda: VJT-012 (PR #55), VJT-013 (PR #59), VJT-014 (PR #61) e VJT-017 (PR #57) mergeados quase simultaneamente por sessões paralelas — todos confirmados via API do GitHub, entradas de log escritas a partir do corpo real de cada PR; único ticket ainda executável da Seção 7 é VJT-015; VJT-011b segue aberto, sem bloqueio). **Adendo pós-consolidação**: PR #63 troca o provider de IA para OpenRouter + DeepSeek (decisão de custo do dono do produto) e, com isso, abre **VJT-017b** (issue #65) — o consentimento LGPD não nomeia os subprocessadores novos e o gate de consentimento ignora a versão do termo; ver a linha destacada acima, que é bloqueante para o deploy da `ai-chat` |
